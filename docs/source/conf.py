...
copyright = u'2011-2018, Andrea Censi'
...
htmlhelp_basename = 'snpgeometrydoc'
...
latex_documents = [
  ('index', '/Users/andrea/scm/writingtools/tex/all_symbols.tex', u'snp_geometry Documentation',
...
man_pages = [
    ('index', 'snp_geometry', u'snp_geometry Documentation',
     [u'Andrea Censi'], 1)
]
